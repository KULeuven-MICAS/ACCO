...
def memory_hierarchy_dut(multiplier_array):
    ...
    # not CACTI-proof
    # sram_96KB_with_12_8K_64_2r_2w = \
    #     MemoryInstance(name="sram_96KB", size=8192 * 12 * 8, r_bw=64 * 8, w_bw=64 * 8, r_cost=3.32 * 8, w_cost=3.85 * 8, area=0, bank=1,
    #                    random_bank_access=True, r_port=2, w_port=2, rw_port=0, latency=1, min_r_granularity=64, min_w_granularity=64)
    #
    # sram_2M_with_8_128K_bank_128_2r_2w_A = \
    #     MemoryInstance(name="sram_2MB", size=262144 * 8 * 8, r_bw=128 * 8, w_bw=128 * 8, r_cost=26.01 * 8, w_cost=23.65 * 8, area=0, bank=1,
    #                    random_bank_access=True, r_port=2, w_port=2, rw_port=0, latency=1, min_r_granularity=64, min_w_granularity=64)
    ...
    memory_hierarchy_graph.add_memory(memory_instance=sram_32KB_with_4_8K_128_1r_1w, operands=('I1', 'O'),
                                      port_alloc=({'fh': 'w_port_1', 'tl': 'r_port_1', 'fl': None, 'th': None},
    ...
    # memory_hierarchy_graph.add_memory(memory_instance=sram_96KB_with_12_8K_64_2r_2w, operands=('I2', 'I1', 'O'),
    #                                   port_alloc=({'fh': 'w_port_2', 'tl': 'r_port_2', 'fl': None, 'th': None},
    #                                               {'fh': 'w_port_1', 'tl': 'r_port_1', 'fl': None, 'th': None},
    #                                               {'fh': 'w_port_1', 'tl': 'r_port_1', 'fl': 'w_port_1', 'th': 'r_port_1'},),
    #                                   served_dimensions='all')
    #
    # memory_hierarchy_graph.add_memory(memory_instance=sram_2M_with_8_128K_bank_128_2r_2w_A, operands=('I2', 'I1', 'O'),
    #                                   port_alloc=({'fh': 'w_port_2', 'tl': 'r_port_2', 'fl': None, 'th': None},
    #                                               {'fh': 'w_port_1', 'tl': 'r_port_1', 'fl': None, 'th': None},
    #                                               {'fh': 'w_port_1', 'tl': 'r_port_1', 'fl': 'w_port_1', 'th': 'r_port_1'},),
    #                                   served_dimensions='all')
    ...
    memory_hierarchy_graph.add_memory(memory_instance=dram, operands=('I1', 'I2', 'O'),
                                      ...
                                      port_alloc=({'fh': 'rw_port_1', 'tl': 'rw_port_1', 'fl': 'rw_port_1', 'th': None},
