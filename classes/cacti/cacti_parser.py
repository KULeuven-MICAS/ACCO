...
class CactiParser:
    ...
    MEM_POOL_PATH = f"{cacti_path}/cacti_master/test_mem_pool.yaml"  # Path to cached cacti simulated memories
...
if __name__ == '__main__':
    ...
    # bank,
    target_mem_config = [
        # ['sram', 96 * 1024 * 8, 64 * 8, 1, 1, 0, 1],
        # ['sram', 64 * 1024 * 8, 64 * 8, 1, 1, 0, 1],
        # ['sram', 32 * 1024 * 8, 64 * 8, 1, 1, 0, 1],
        # ['sram', 64 * 1024 * 8, 64 * 8, 2, 2, 0, 1],
        # ['sram', 32 * 1024 * 8, 64 * 8, 2, 2, 0, 1],
        # ['sram', 96 * 1024 * 8, 64 * 8, 2, 2, 0, 1],
        # ['sram', 128 * 1024 * 8, 64 * 8, 1, 1, 0, 1]
    ]

    target_mem_config = [
        # ['sram', 96 * 1024 * 8, 64 * 8, 1, 1, 0, 1],
        ['sram', 1024 * 8, 256, 1, 1, 0, 1],
        ['sram', 8192 * 8, 128, 1, 1, 0, 1],
        ['sram', 16384 * 8, 256, 1, 1, 0, 1],
        # ['sram', 8192 * 8 * 8, 128 * 8, 1, 1, 0, 8],
        # ['sram', 96 * 1024 * 8, 64 * 8, 2, 2, 0, 1],
        # ['sram', 131072 * 8 * 8, 128 * 8, 1, 1, 0, 1],
        # ['sram', 262144 * 8 * 8, 128 * 8, 2, 2, 0, 1],
    ]

    for [mem_type, size, r_bw, r_port, w_port, rw_port, bank] in target_mem_config:
        print(mem_type, size, r_bw, r_port, w_port, rw_port, bank)
        result = C.get_item(mem_type, size, r_bw, r_port, w_port, rw_port, bank)
        print('cache_size, IO_bus_width, IO_bus_width, read_cost, write_cost, area, bank_count, ex_rd_port, ex_wr_port, rd_wr_port')
        print(result)
